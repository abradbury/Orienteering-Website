			...
			<?php // If the field is hidden, just display the input. ?>
				...
				<?php else : ?>
					<div class="form-group">
						...
						<?php if ($field->fieldname == 'password1') : ?>
						<div class="col-sm-2">
							<span class="help-block"><?php echo JText::_('COM_USERS_PROFILE_PASSWORD_POLICY'); ?></span>
						</div>
						<?php endif; ?>
					</div>
				<?php endif;?>
	...
	<?php endif; ?>
		...
		<div class="control-group">
			...
			<div class="col-sm-4 col-xs-6">
				<a class="btn btn-danger btn-block" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
			</div>	
