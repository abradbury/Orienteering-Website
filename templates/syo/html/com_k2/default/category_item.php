...
<article class="news-item group<?php echo ucfirst($this->item->itemGroup); ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php 
	// Checks if there are any leading articles and if so, does not print the article title and 
	// information for the first one - the page header is usually used instead. 
	if ((!isset($this->leading) || !count($this->leading)) || (isset($this->leading) && count($this->leading) && ($this->item->id != $this->leading[0]->id))):
	?>
	...
	<div class="catItemHeader">
		...
		<h2 class="catItemTitle">
			...
			<a class="openExampleModal" href="#" data-toggle="modal" data-target="#editModal" data-url="<?php echo $this->item->editLink; ?>"><?php echo JText::_('K2_EDIT_ITEM'); ?></a>
			<?php endif; ?>
		</h2>
		<?php endif; ?>
		...
		<div class="news-item-info">
			...
			<!-- Date created -->
			<span class="glyphicon glyphicon-time"></span> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?>
			<?php endif; ?>

			<?php if($this->item->params->get('catItemAuthor')): ?>
			<span class="article-info-sep"></span>
			<!-- Item Author -->
  ...
  <div class="clr"></div>
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore" href="<?php echo $this->item->link; ?>">
			<?php echo JText::_('TPL_SYO_COM_K2_CONTINUE_READING'); ?> <?php echo $this->item->title; ?><?php echo JText::_('TPL_SYO_COM_K2_ELLIPSIS'); ?>
		</a>
	</div>
	<?php endif; ?>
	...
	<span class="catItemDateModified">
		<span class="glyphicon glyphicon-time"></span> <?php echo JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?>
	</span>
	<?php endif; ?>
	<?php endif; ?>
