...
<form class="form-horizontal" action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm">
	...
	<div id="k2Frontend">
		...
		<div id="k2FrontendEditToolbarMembers">
			<div id="itemFormEditButtons" class="pull-right">
				...
				<button id="cancelEdit" class="btn btn-danger" onclick="Joomla.submitbutton('cancel'); return false;"><?php echo JText::_('K2_CLOSE'); ?></button>
			</div>
