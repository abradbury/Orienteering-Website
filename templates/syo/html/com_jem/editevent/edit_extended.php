...
<!-- RECURRENCE START -->
<div>
	<fieldset class="panelform mb-3">
		<legend><?php echo Text::_('COM_JEM_RECURRENCE'); ?></legend>
		<div class="adminformlist">
			<div><?php echo $this->form->getLabel('recurrence_type'); ?> <?php echo $this->form->getInput('recurrence_type'); ?></div>
			<div id="recurrence_output"><label></label></div>
