...
<html lang="en">
	...
	<link rel="stylesheet" href="/media/templates/site/syo/css/error.css?v=4">
	...
	<div class="container">
		<div class="text">
			...
			<div class="description">
				...
				<p><a href="<?php echo Uri::base(); ?>"><?php echo Uri::base(); ?></a></p>
		...
		<div class="image">
			...
			<img src="<?php echo $this->baseurl; ?>/media/templates/site/syo/images/errors/error7.jpg" />

			<?php } else { ?>
			<img src="<?php echo $this->baseurl; ?>/media/templates/site/syo/images/errors/error6.jpg" />
			<?php } ?>
		</div>
	</div>
</body>
